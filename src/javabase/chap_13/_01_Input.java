...
//        String name = sc.next(); // 사용자에게 입력을 받은 값을, String으로 받아줌
//        System.out.println("혈액형을 입력하세요");
//        String bloodType = sc.next();
//        System.out.println("키를 입력하세요");
//        // int height = Integer.parseInt(sc.next()); // Integer.parseInt -> String을 int로 형변환
...
//        System.out.println("몸무게 : " + weight);
        ...
        System.out.println("배우고 나니 기분을 어땠나요?");
